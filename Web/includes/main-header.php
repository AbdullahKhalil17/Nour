      ...
      <div class="row align-items-center">
        <div class="col-lg-3 col-md-3 col-7">
          ...
          <a class="navbar-brand" href="index.html">
            <img src="../web/assets/images/logo/logo.svg" alt="Logo">
          </a>
          <!-- End Header Logo -->
        </div>
              ...
              <div class="cart-items">
                ...
                <div class="shopping-item">
                  ...
                  <ul class="shopping-list">
                    <?php
                    // فحص وجود عناصر في السلة
                    if (isset($_SESSION['cart'])) {
                      foreach ($_SESSION['cart'] as $cartItem) :
                    ?>
                        <li>
                        <a href="javascript:void(0)" class="remove" title="Remove this item" onclick="removeFromCart(<?php echo $cartItem['id']; ?>)">
                          <i class="lni lni-close"></i>
                        </a>
                          <div class="cart-img-head">
                            <a class="cart-img" href="product_details.php?id=<?= $cartItem['id']; ?>">
                              <img src="admin/assets/images/image_product/<?php echo $cartItem['image']; ?>" alt="<?php echo $cartItem['product_name']; ?>">
                            </a>
                          </div>
                          <div class="content">
                            <h4><a href="product_details.php?id=<?= $cartItem['id']; ?>"><?php echo $cartItem['product_name']; ?></a></h4>
                            <p class="quantity">
                              <?php echo $cartItem['quantity']; ?>x -
                              <span class="amount">$<?php echo $cartItem['price']; ?></span>
                            </p>
                          </div>
                        </li>
                    <?php
